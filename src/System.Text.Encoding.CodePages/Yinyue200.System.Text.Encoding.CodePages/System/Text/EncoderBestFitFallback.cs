    ...
    internal sealed class InternalEncoderBestFitFallbackBuffer : EncoderFallbackBuffer
    {
        ...
        public override bool Fallback(char charUnknownHigh, char charUnknownLow, int index)
        {
            ...
            if (!Char.IsHighSurrogate(charUnknownHigh))
                throw new ArgumentOutOfRangeException(nameof(charUnknownHigh), SR.Format(Yinyue200.ClrSystem.Text.Encoding.CodePages.Resources.Strings.ArgumentOutOfRange_Range, 0xD800, 0xDBFF));

            if (!Char.IsLowSurrogate(charUnknownLow))
                throw new ArgumentOutOfRangeException(nameof(charUnknownLow), SR.Format(Yinyue200.ClrSystem.Text.Encoding.CodePages.Resources.Strings.ArgumentOutOfRange_Range, 0xDC00, 0xDFFF));
